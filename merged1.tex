%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% C++ Cheat Sheet + Reference Card (3-Column Poster Layout)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{columns}[t,totalwidth=0.9\paperwidth, colsep=0.015\paperwidth]

% ---------------- Column 1 ----------------
\begin{column}{0.3\paperwidth}
\
\begin{block}{Standard Template Library (STL)}
\begin{lstlisting}[language=C++]
#include <vector>
#include <map>
#include <set>
