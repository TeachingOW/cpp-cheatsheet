...
\begin{block}{Decision Statements}
\end{block}
...
\begin{block}{Dynamic Memory}
\end{block}

\begin{block}{Allocate Memory}
\begin{tabular}{|l|l|}
\hline
...
\begin{block}{Console Input/Output}
\begin{itemize}
