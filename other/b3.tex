...
\begin{frame}{Relational Algebra}
    ...
    \begin{itemize}
        ...
        \item Each operator takes one or more relations as its inputs and outputs a new relation. 
    \end{itemize}
    \vspace{1em}
    \begin{columns}
        \column{0.5\textwidth}
...
\begin{frame}[fragile]{Relational Algebra: Select}
    \begin{columns}
        ...
        \textbf{R(a\_id,b\_id)}
        \begin{table}\tiny
        \begin{tabular}{ll} \toprule a\_id & b\_id \\ \midrule a1 & 101 \\ a2 & 102 \\ a2 & 103 \\ a3 & 104 \\ \bottomrule \end{tabular}
        \end{table}
        \column{0.3\textwidth}
        $\sigma_{a\_id='a2'}(R)$
        \begin{table}\tiny
        \begin{tabular}{ll} \toprule a\_id & b\_id \\ \midrule a2 & 102 \\ a2 & 103 \\ \bottomrule \end{tabular}
        \end{table}
        \column{0.4\textwidth}
