...
\begin{frame}
    \centering
    %\includegraphics[width=0.8\textwidth]{imgs/extracted_p2_1_image.png} 
...
\begin{frame}{Reddit Context}
    \begin{columns}
        \column{0.5\textwidth}
        \includegraphics[width=\textwidth]{imgs/extracted_p3_0_Image41.jpg}
        \column{0.5\textwidth}
...
\begin{frame}{Reddit Context}
    \centering
    \includegraphics[width=0.8\textwidth]{imgs/extracted_p4_0_Image41.jpg}
    \vspace{1em}
    \begin{quote}
...
\begin{frame}{Early DBMSs}
    \begin{columns}
        ...
        \column{0.4\textwidth}
        \centering
        \includegraphics[width=0.8\textwidth]{imgs/extracted_p25_0_Image219.png} % Codd Photo
    \end{columns}
\end{frame}
...
\begin{frame}{Relational Model (1970)}
    \centering
    \includegraphics[width=0.3\textwidth]{imgs/extracted_p26_0_Image241.png} \hspace{0.5em}
    \includegraphics[width=0.3\textwidth]{imgs/extracted_p26_1_Image230.jpg} \hspace{0.5em}
    \includegraphics[width=0.3\textwidth]{imgs/extracted_p26_2_Image248.png}
    \\
...
\begin{frame}{CODASYL}
    ...
    \end{itemize}
    \centering
    \includegraphics[width=0.8\textwidth]{imgs/extracted_p27_1_image270.png} % Network diagrams
\end{frame}
...
\begin{frame}{The Great Debate (1974)}
    ...
    \vspace{1em}
    \centering
    \includegraphics[height=1.5cm]{imgs/extracted_p27_0_image258.png} % Bachman
    \includegraphics[height=1.5cm]{imgs/extracted_p27_1_image270.png} % Gray
    \includegraphics[height=1.5cm]{imgs/extracted_p27_3_image272.jpg} % Stonebraker
    \includegraphics[height=1.5cm]{imgs/extracted_p27_4_image273.jpg} % Codd
\end{frame}
...
\begin{frame}{Data Independence}
    ...
    \begin{columns}
        ...
        \end{itemize}
        \column{0.4\textwidth}
        \includegraphics[width=\textwidth]{imgs/extracted_p31_0_Image308.png} % Architecture Diagram
    \end{columns}
\end{frame}
